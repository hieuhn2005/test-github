    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-4 col-md-3 sidebar">
          ...
          <div class="widget">
            ...
            <ul class="widget-posts">
              ...
              <li class="clearfix">
                <div class="widget-posts-image"><a href="#"><img src="{{ asset('client/assets/images/rp-3.jpg') }}" alt="Post Thumbnail"/></a></div>
                <div class="widget-posts-body">
              ...
              <li class="clearfix">
                <div class="widget-posts-image"><a href="#"><img src="{{ asset('client/assets/images/rp-4.jpg') }}" alt="Post Thumbnail"/></a></div>
                <div class="widget-posts-body">
        ...
        <div class="col-sm-8 col-sm-offset-1">
          <div class="post">
            <div class="post-thumbnail"><a href="#"><img src="{{ asset('client/assets/images/post-1.jpg') }}" alt="Blog-post Thumbnail"/></a></div>
          ...
          <div class="post">
            <div class="post-images-slider">
              <ul class="slides">
                <li><img src="{{ asset('client/assets/images/post-1.jpg') }}" alt="Blog Slider Image"/></li>
                <li><img src="{{ asset('client/assets/images/post-3.jpg') }}" alt="Blog Slider Image"/></li>
              </ul>
            </div>
            <div class="post-header font-alt">
